...
class CartSessionTest extends TestCase
{
    ...
    {
        if (is_dir('C:\wamp64\www\ProgrammingPatterns\tmp\event-store')) {
            @rmdir('C:\wamp64\www\ProgrammingPatterns\tmp\event-store');
        }

        @mkdir('C:\wamp64\www\ProgrammingPatterns\tmp\event-store', 0777);
    }
